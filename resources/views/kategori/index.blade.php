                                    ...
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <form action="{{ route('kategori.destroy', $kategori->id) }}" method="POST" class="inline-block">
                                            ...
                                            <button type="submit" 
                                                    ...
                                                    class="inline-flex items-center px-3 py-1.5 bg-red-600 text-white text-sm rounded-md hover:bg-red-700 transition duration-150 ease-in-out">
