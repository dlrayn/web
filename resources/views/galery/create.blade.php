...
<div class="max-w-4xl mx-auto">
    <header class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800">
            <span class="text-indigo-600">✨</span> Tambah Galeri Baru
        </h1>
    </header>

    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8">
            <form action="{{ route('galery.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <select name="post_id" 
                                ...
                                required>
                            <option value="" disabled selected>Pilih Post</option>
